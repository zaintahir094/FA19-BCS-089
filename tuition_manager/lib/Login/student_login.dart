...
import 'package:tuition_manager/signup/students.dart';
import 'package:tuition_manager/Student/Student_home.dart';
import '../Forget pages/student_forget_password.dart';
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>StForgotPassword(),));
                                    },
                                    child: Container(
                                      margin: EdgeInsets.symmetric(
                                          vertical: 24, horizontal: 20),
